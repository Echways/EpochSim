...
namespace EpochSim.Cli.App
{
    public sealed class CliApp
    {
        ...
        public CliApp()
        {
            ...
            _commands["run"] = new RunCommand();
            _commands["validate-run"] = new ValidateRunCommand();
            _commands["fast-replay"] = new FastReplayCommand();
            _commands["verify-run"] = new VerifyRunCommand();
            _commands["event-stats"] = new EventStatsCommand();
            _commands["timeline"] = new TimelineCommand();
            _commands["pretty-inspect"] = new PrettyInspectCommand();
            _commands["list-runs"] = new ListRunsCommand();
            _commands["inspect-run"] = new InspectRunCommand();
            _commands["bisect"] = new BisectCommand();
            _commands["repro"] = new ReproCommand();
        }
        ...
        public Task<int> RunAsync(string[] args)
        {
            ...
            ICliCommand? command;
            if (!_commands.TryGetValue(cmd, out command) || command is null)
            {
                PrintUsage();
